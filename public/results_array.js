...
let linksObj = {
    "a": `
        ...
        <a href="https://www.youtube.com/@timeisnotahealer" target="_blank" class="link social-list-link">
             <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="icon icon-podcasts" viewBox="0 0 16 16" id="podcasts">
        <rect width="25" height="25" x=".463" fill="url(#a)" rx="8"></rect>
        <path fill="#fff" d="M10.5732 14.6068C10.5732 13.7439 11.2923 13.1686 12.371 13.1686C13.4496 13.1686 14.1687 13.7439 14.1687 14.6068C14.1687 16.4045 13.8092 20 12.371 20C10.9328 20 10.5732 16.4045 10.5732 14.6068Z"></path>
        <path fill="#fff" fill-rule="evenodd" d="M6.07865 11.3708C6.07865 7.89574 8.89574 5.07865 12.3708 5.07865C15.8458 5.07865 18.6629 7.89574 18.6629 11.3708C18.6629 13.8771 17.1975 16.0413 15.0766 17.053C15.0208 17.4509 14.9489 17.8497 14.8579 18.2293C14.8507 18.2592 14.8433 18.2892 14.8358 18.3193C17.6944 17.3052 19.7416 14.577 19.7416 11.3708C19.7416 7.30001 16.4415 4 12.3708 4C8.30001 4 5 7.30001 5 11.3708C5 14.577 7.0472 17.3052 9.90578 18.3193C9.89826 18.2892 9.8909 18.2592 9.88372 18.2293C9.79264 17.8497 9.72078 17.4509 9.66492 17.053C7.54411 16.0413 6.07865 13.8771 6.07865 11.3708Z" clip-rule="evenodd"></path>
        <path fill="#fff" fill-rule="evenodd" d="M8.59574 11.3708C8.59574 9.28575 10.286 7.5955 12.371 7.5955C14.4561 7.5955 16.1463 9.28575 16.1463 11.3708C16.1463 12.3548 15.7699 13.2508 15.1532 13.9228C15.2151 14.1394 15.2474 14.3686 15.2474 14.6067C15.2474 14.8139 15.243 15.0447 15.233 15.2917C16.4406 14.4087 17.225 12.9813 17.225 11.3708C17.225 8.69003 15.0518 6.51685 12.371 6.51685C9.69027 6.51685 7.51709 8.69003 7.51709 11.3708C7.51709 12.9813 8.30149 14.4087 9.50911 15.2917C9.49906 15.0447 9.49462 14.8139 9.49462 14.6067C9.49462 14.3686 9.52696 14.1394 9.58892 13.9228C8.97219 13.2508 8.59574 12.3548 8.59574 11.3708Z" clip-rule="evenodd"></path>
        <path fill="#fff" d="M12.3709 12.4495C13.2645 12.4495 13.9889 11.7251 13.9889 10.8315C13.9889 9.93789 13.2645 9.2135 12.3709 9.2135C11.4773 9.2135 10.7529 9.93789 10.7529 10.8315C10.7529 11.7251 11.4773 12.4495 12.3709 12.4495Z"></path>
        <defs>

...
let readMoreObj = {
    ...
    "b": `
        <p>
            ...
            <p class="content-rm">Some of our favorite sleep hygiene practices at TINAH are to start unwinding with the <a href="https://timeisnotahealer.com/products/cosmic-dealer-organic-ayurvedic-teas-infusions" target="_blank">The Cosmic Dealer Ayuverdic Tea Blend</a> blend, while you use your <a href="https://timeisnotahealer.com/products/night-routine-journal" target="_blank">Wilde House Paper Nightly Journal</a> to get out any remaining thoughts from the day. When you are ready for bed, switch on your <a href="https://timeisnotahealer.com/products/zeez-sleep-pebble" target="_blank">Zeez Sleep Pebble</a>, which mimics the alpha, theta and delta frequencies generated by the brain of a good sleeper to help your body get into a good regular sleep pattern.</p>
            ...
            <p class="content-rm">We get it though that sometimes making the leap to get back into the gym can be really hard. Like REALLY HARD. At TINAH, we recognize the importance of taking baby steps, but TAKING THEM nonetheless. We recommend the <a href="https://timeisnotahealer.com/products/yogi-bare-warm-sand-ever-grip%E2%84%A2-paws" target="_blank">Yogi Bare Ever Grip Mat</a> for getting started with basic body movements at home! PSST… Use code <span>TINAH</span> at checkout and you’ll get 15% off your order.</p>
            ...
            <ul>
                ...
                <li><span class="journal">Journal: </span><a href="https://timeisnotahealer.com/products/mal-paper-day-of-gratitude-journal-black" target="_blank">A day of gratitude journal from MalPaper</a></li>
            </ul>
        </p>`,
...
let linksObj = {
    "a": `
        <a href="https://www.youtube.com/@timeisnotahealer" target="_blank" class="link social-list-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="26" fill="currentColor" class="icon icon-youtube" viewBox="0 0 16 16" id="youtube" transform="translate(0, 2)">
        ...
        <a href="https://open.spotify.com/show/6BGZpHiOatuMzhaf9JeWVC?si=9b98cb310cfb48f6" target="_blank" class="link social-list-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="26" fill="currentColor" class="icon icon-spotify" viewBox="0 0 16 16" id="spotify" transform="translate(0, 0.5)">
   ...
   <svg xmlns="http://www.w3.org/2000/svg" width="25" height="26" fill="currentColor" class="icon icon-podcasts" viewBox="0 0 120 120" id="podcasts">
        ...
        <path fill="current-color" d="M60,0A60,60 0 1,1 60,120A60,60 0 1,1 60,0Z" transform="translate(0, 2)"></path>

...
let linksObj = {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="icon icon-podcasts" viewBox="0 0 120 120" id="podcasts">
        ...
        <path fill="url(#a)" d="M60,0A60,60 0 1,1 60,120A60,60 0 1,1 60,0Z"></path>
        <path fill="#e36b2b" d="M74.9,79.7l.5-4.4a8.85417,8.85417,0,0,0,0-2.3,23,23,0,1,0-30.8,0,17.63337,17.63337,0,0,0,0,2.3l.5,4.4a28,28,0,1,1,29.8,0ZM73.2,94.9l.6-5.5a37.125,37.125,0,1,0-27.6-.1l.6,5.5a41.84979,41.84979,0,1,1,26.4.1Z" transform="translate(0, 5)"></path>
